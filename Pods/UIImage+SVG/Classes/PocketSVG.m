...
{    
    ...
    {
        NSString *viewBox = [rootXML attribute: @"viewBox"];
        NSArray *boxComponents = [viewBox componentsSeparatedByString:@" "];
        widthString = boxComponents[2];
        heightString = boxComponents[3];
    }
